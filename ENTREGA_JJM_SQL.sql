...
alter table ENTREGA_JJM_SQL.AUTO 
	...
	foreign key (ANIO_FABRICACION) references ENTREGA_JJM_SQL.ANIO(ANIO_FABRICACION);
...
alter table ENTREGA_JJM_SQL.auto 
	...
	references ENTREGA_JJM_SQL.MODELO_AUTO(CODIGO_MODELO);
...
alter table ENTREGA_JJM_SQL.MODELO_AUTO -- RELACIONO MODELO CON MARCA
	...
	foreign key (CODIGO_MARCA) references ENTREGA_JJM_SQL.LISTA_MARCAS(CODIGO_MARCA);
...
alter table ENTREGA_JJM_SQL.AUTO
	...
	references ENTREGA_JJM_SQL.VERSIONES_AUTO(CODIGO_VERSION);
...
alter table ENTREGA_JJM_SQL.datos_poliza 
	...
	foreign key (CODIGO_MONEDA) references ENTREGA_JJM_SQL.TIPO_MONEDA(CODIGO_MONEDA);
	

alter table ENTREGA_JJM_SQL.AUTO
	add constraint AUTO_FK2 foreign key(NUMERO_POLIZA)
	references ENTREGA_JJM_SQL.DATOS_POLIZA(NUMERO_POLIZA);
...
alter table ENTREGA_JJM_SQL.itv 
	...
	references ENTREGA_JJM_SQL.AUTO(MATRICULA);

alter table ENTREGA_JJM_SQL.itv 
	add constraint ITV_FK2 foreign key (CODIGO_MONEDA)
	references ENTREGA_JJM_SQL.TIPO_MONEDA(CODIGO_MONEDA);
...
alter table ENTREGA_JJM_SQL.auto 
	...
	references ENTREGA_JJM_SQL.CATALOGO_COLOR(CODIGO_COLOR);
...
alter table ENTREGA_JJM_SQL.ESPECIFICOS_ANIO
	...
	references ENTREGA_JJM_SQL.ANIO(ANIO_FABRICACION);

alter table ENTREGA_JJM_SQL.ESPECIFICOS_ANIO
	add constraint ESPECIFICOS_ANIO_FK2
	foreign key (CODIGO_MARCA) 
	references ENTREGA_JJM_SQL.LISTA_MARCAS(CODIGO_MARCA);

alter table ENTREGA_JJM_SQL.ESPECIFICOS_ANIO
	add constraint ESPECIFICOS_ANIO_FK3
	foreign key (CODIGO_GARANTIA) 
	references ENTREGA_JJM_SQL.CATALOGO_GARANTIAS(CODIGO_GARANTIA);
...
alter table ENTREGA_JJM_SQL.GRUPO_EMPRESARIAL_ANIO
	...
	references ENTREGA_JJM_SQL.GRUPO_EMPRESARIAL(ID_GRUPO_EMPRESARIAL);
