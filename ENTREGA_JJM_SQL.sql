...
alter table AUTO -- DATOS QUE UNICOS AL AUTO EN INVENTARIO
...
create table LISTA_MARCAS(
	codigo_marca serial unique,
	marca varchar(50)
	
);

alter table LISTA_MARCAS -- GENERO LISTA DE MARCAS
	add constraint MARCA_PK
	primary key (CODIGO_MARCA);

alter table MODELO_AUTO -- RELACIONO MODELO CON MARCA
...
create table ITV(  -- control de revisiones ITV
	ITV_SERIAL serial, 
...
alter table itv -- GENERO las PK de ITV
...
create table SERVICIOS_AUTO(  -- control DE SERVICIOS DE MANTENIMIENTO AL AUTO
...
create table CATALOGO_COLOR(  -- CATALOGO TOTAL DE COLORES
	CODIGO_COLOR varchar(50) not null unique,
	COLOR varchar(100) not null
);


alter table catalogo_color 
...
create table ESPECIFICOS_ANIO( --- datos específicos de las garantías del modelo según situación en cada año
	ANIO_FABRICACION integer not null,
	CODIGO_MARCA INTEGER not null,
...
create table CATALOGO_GARANTIAS(
...
create table GRUPO_EMPRESARIAL_ANIO(
...
alter table GRUPO_EMPRESARIAL_ANIO
...
insert into CATALOGO_COLOR (CODIGO_COLOR, COLOR) 
...
insert into LISTA_MARCAS  (MARCA)
values ('ALFA ROMEO');
...
insert into MODELO_AUTO(CODIGO_MARCA, MODELO)
values ('1', '4C');
...
insert into versiones_auto (CODIGO_MODELO, version_modelo)
values ('1', 'Spider');
...
insert into ANIO(ANIO_FABRICACION)
values ('2019');
...
insert into CATALOGO_GARANTIAS(TIEMPO_GARANTIA, KMS_SERVICIO, TIEMPO_SERVICIO)
...
insert into grupo_empresarial(grupo_empresarial)
values ('GRUPO FIAT');
...
insert into grupo_empresarial_anio (Anio_FABRICACION, ID_GRUPO_EMPRESARIAL, CODIGO_MARCA)
values ('2021', '3', '1');
...
insert into TIPO_MONEDA (CODIGO_MONEDA, MONEDA)
values ('EUR', 'EURO');
...
INSERT INTO auto (codigo_version,numero_poliza,anio_fabricacion,matricula,fecha_compra,kilometraje,frame_number,codigo_modelo,codigo_color) VALUES
...
INSERT INTO servicios_auto (matricula,codigo_version,kms_ultimo_servicio,fecha_ultimo_servicio,monto_pago_ultimo_servicio,codigo_moneda,kms_proximo_servicio,fecha_proximo_servicio) VALUES
...
-- -- AHORA INCLUYO REVISIONES DE LA ITV
	...
	INSERT INTO itv (matricula,fecha_ultima_verificacion,fecha_proxima_verificacion,monto_pago_ultima_verificacion,codigo_moneda) VALUES
...
INSERT INTO especificos_anio (anio_fabricacion,codigo_marca,codigo_garantia)
	VALUES (2019,1,2);
INSERT INTO especificos_anio (anio_fabricacion,codigo_marca,codigo_garantia)
	VALUES (2020,1,2);
INSERT INTO especificos_anio (anio_fabricacion,codigo_marca,codigo_garantia)
